     ...
     <nav role="navigation" class="navbar navbar-default ">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
             ...
             <ul class="nav navbar-nav">
                <li class="active"><a href="">Anulados</a></li>
            </ul>
            ...
            Bienvenid@ <?php echo $nombreE; ?> - <a href="" class="navbar-link"></a>
        </p>
      
        </div>
</nav>
        
<h1><center>Lista de Productos Importación Anulados</center>
</h1>
